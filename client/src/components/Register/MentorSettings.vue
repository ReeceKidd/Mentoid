<template>
  <div class="container">
    ...
    <mentor-settings-form></mentor-settings-form>
     ...
     <div class="row">
      <div class="col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2 col-md-6 col-offset-3">  
        <hr>

        <!-- Desktop -->
        <span class="hidden-xs">
          <button type="submit" class="btn btn-md btn-primary" @click="navigateTo('/upload-profile-picture')">
