...
<div>
    ...
    <span v-for="(mentor, index) in potentialOnlineAndInPersonMentors" :key="index">
      ...
      <div class="row">
        <div class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center displayBox">
          ...
          <span id="travelDistance" v-if="mentor.distanceKM">
              <div class="distance" v-if="mentor.isWithinUsersRange">
                <p><b>Distance: <span class="match"> {{mentor.distanceKM }}KM</span></b></p>
              </div>
              <div class="distance" v-if="!mentor.isWithinUsersRange">
                <p><b>Distance: <span class="notAMatch"> {{mentor.distanceKM }}KM</span></b></p>
              </div>
            </span>
          <div class="hidden-xs">
  ...
  <br>
  <div v-if="potentialOnlineAndInPersonMentors.length === 0" class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 displayBox">
...
<script>
  ...
  export default {
    ...
    beforeMount() {
      // Gets the compatibility score for each mentor
