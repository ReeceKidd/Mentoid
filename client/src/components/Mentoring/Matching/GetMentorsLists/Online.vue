<template>
  <div>
  <div v-if="potentialOnlineMentors.length !== 0">
    <h2 class="text-center"> {{ potentialOnlineMentors.length }} Potential Online Mentors </h2>
      ...
      <div class="row">
        <div class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center displayBox">
          ...
          <span id="languages">
            <h5>
              <b> Languages: </b>
              <span v-for="(language, mIndex) in mentor.mentorSettings.languages" :key="mIndex">
  ...
  <br>
  <div v-if="potentialOnlineMentors.length === 0" class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 displayBox">
  ...
  export default {
    ...
    data() {
      return {
        ...
        potentialOnlineMentors: this.mentors
      }
    },
    methods: {
      mentorMatch(mentor) {
