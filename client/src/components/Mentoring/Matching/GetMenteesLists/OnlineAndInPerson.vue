...
<div>
      ...
      <div class="row">
        <div class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center displayBox">
          ...
          <span id="canMentorYouIn">
            ...
            <span v-for="(areaOfInterest, aIndex) in mentee.mentorHasLessExperience" :key="aIndex">
          ...
          <span id="prefferedMentoringFormat">
            ...
            <span v-for="(mentoringFormat, mIndex) in mentee.mentorSettings.prefferedMentoringFormats" :key="mIndex">
          ...
          <div class="hidden-xs">
            ...
            <button class="btn btn-success btn-sm" @click="applyToMentor(mentee._id)"> Apply for Mentoring </button>
          </div>
  ...
  <br>
  <div v-if="potentialOnlineAndInPersonMentees.length === 0" class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 displayBox">
  ...
  export default {
    ...
    data() {
      return {
        ...
        potentialOnlineAndInPersonMentees: this.mentees
      }
    },
    methods: {
      menteeMatch(mentee) {
      ...
      applyToMentor(mentorID) {
        ...
        var that = this
        const applyForMentorshipURL = 'http://localhost:4000/apply-to-mentor/'
