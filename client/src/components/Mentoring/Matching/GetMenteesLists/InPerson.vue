<template>
<div>
  <div v-if="potentialInPersonMentees.length !== 0">
    <h2 class="text-center"> {{ potentialInPersonMentees.length }} Potential In Person Mentees </h2>
    <span v-for="(mentee, index) in potentialInPersonMentees" :key="index">
      <br>
      <div class="row">
        <div class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center displayBox">
          ...
          <p v-if="mentee.compatibilityScore >= 40" class="infoMessage"> Compatibility:
            ...
            <span id="canMentorYouIn">
              ...
              <span v-for="(areaOfInterest, aIndex) in mentee.menteeHasLessExperienceIn" :key="aIndex">
            ...
            <span id="travelDistance">
              <p class="distance">
                <b>Distance: {{ mentee.distanceKM }}KM</b>
              </p>
            </span>
            <div class="hidden-xs">
    ...
    <br>
    <div v-if="potentialInPersonMentees.length === 0" class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 displayBox">
      <h3>No potential mentees found. Change your settings to get more matches </h3>
      <p>
        <a href='edit-profile#mentor-preferences'> Change your Mentor settings
  ...
  export default {
    ...
    data() {
      return {
        ...
        potentialInPersonMentees: this.mentees
      }
    },
    methods: {
      mentorMatch(mentee) {
      ...
      getProfilePicture(menteesID) {
        return getProfilePictureURL + menteesID
      },
