...
module.exports = getCurrentMentees = (req, res) => {

    logger.warn(req.params.userID + ' is attempting to get their current mentees with ' + JSON.stringify(req.params))
    ...
    User.findById(req.params.userID, function (err, user) {
        ...
        logger.warn(user.userName + ' successfully retrieved: Mentees information: ' +
