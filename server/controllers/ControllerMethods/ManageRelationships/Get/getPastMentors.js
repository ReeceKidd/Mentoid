...
module.exports = getPastMentors = (req, res) => {

    logger.warn(req.params.userID + ' is attempting to get their past mentors with ' + JSON.stringify(req.params))
    ...
    User.findById(req.params.userID, function (err, user) {
        ...
        logger.warn(user.userName + ' successfully retrieved: past mentors ' +
        ' -Number of passed mentors: ' + user.pastMentors.length) 
        res.status(200).send({
