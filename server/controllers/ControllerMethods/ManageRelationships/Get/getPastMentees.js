...
module.exports = getCurrentMentors = (req, res) => {

    logger.warn(req.params.userID + ' is attempting to get their past mentees with ' + JSON.stringify(req.params))
    ...
    User.findById(req.params.userID, function (err, user) {
        ...
        logger.warn(user.userName + ' successfully retrieved: Past mentees: ' +
        ' -Number of passed mentees: ' + user.pastMentees.length) 
        res.status(200).send({
